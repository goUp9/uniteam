App.controller('AdviseCtrl', function($http,Spinner,$scope){
        var self=this;
        this.userMsg="";
        ...
        this.get_asks=function() {
            ...
            $http({
                method  : 'POST',
                url     : 'http://'+document.domain+'/ajax/myuin-get-advices/',
        ...
        this.remove_loc=function($parentIndex,$index){  
            Spinner.spin();
             
            var id=$scope.queries[$parentIndex].wheres[$index].id;
