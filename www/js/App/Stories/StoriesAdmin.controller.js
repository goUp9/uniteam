Admin.controller('StoriesAdminCtrl', function($http, $scope){
        var self=this;
        ...
        $scope.add_item=function(id){
            id=id||null;
            var url='http://'+document.domain+'/admin/manage-stories-article/';
            if(id!==null){
                url=url+id+'/';
            }
        ...
        $scope.delete_item=function($index){
            ...
            var url='http://'+document.domain+'/admin/delete-stories-article/'; 
            $http
                ({ 
                    method  : 'POST',
                    url     : url,
        ...
        $scope.get_comments=function(idArticle){
                ...
                $http
                    ({ 
                        method  : 'GET',
                        url     : 'http://'+document.domain+'/admin/get-stories-comments/'+idArticle+'/',
                        headers : { 'Content-Type': 'application/x-www-form-urlencoded','X-Requested-With':'XMLHttpRequest' }
        ...
        $scope.delete_comment=function($index){
            ...
            var url='http://'+document.domain+'/admin/delete-stories-comment/';
            $http
                ({ 
                    method  : 'POST',
                    url     : url,
